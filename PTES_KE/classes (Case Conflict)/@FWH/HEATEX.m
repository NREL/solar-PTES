classdef HEATEX 
    ...
    properties
        ...
        type    % 'RCP' for recuperator, 'INT' for intercooler, 'REJ' for heat rejection to environment, 'HS' for hot store, 'CS' for cold store, 'SOL' for solar heat addition, 'pre', 'sup' 'vap' for preheaters, superheaters and vaporizers
    end
    ...
    methods
        ...
        % Calculate heat transfer into/outof a stream
