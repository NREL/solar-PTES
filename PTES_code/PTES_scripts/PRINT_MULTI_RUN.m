...
switch Load.mode
    case 0
        ...
        save(filename,'PRch','PRr','T0','eta','eff','ploss','chi_PTES','chi_PTES_para','rhoE',...
            'W_in_chg','W_net_chg','W_out_dis','W_net_dis',...
            'QH_chg','QH_dis','QC_chg','QC_dis','Heat_rejected',...
            'WL_PTES_chg','WL_PTES_dis','t_chg','t_dis',...
    ...
    case 3
        ...
        save(filename,'PRch','PRr','T0','eta','eff','ploss','chi','COP','EFF','rhoE',...
