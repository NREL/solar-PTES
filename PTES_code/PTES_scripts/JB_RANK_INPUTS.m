...
T0Matrix=readmatrix('./Outputs/Multi_run/Apntcounter.csv'); %Ambient temperature values supplied from PTES file, but can also be used for other variables.
count=readmatrix('./Outputs/Multi_run/Npntcounter.csv');
if count>0
    T0=T0Matrix(count);
else
    T0 = 30 + 273.15;
...
%PRr     = 1.6;          % discharge pressure ratio: PRdis = PRch*PRr
