classdef fluidhybrid_class
    properties
        ...
        statehybrid = statehybrid_class;
        stage = stage_class;
        Nstg   % number of stages
        cost   % Cost per kg
    end
    methods
        function obj = fluidhybrid_class(name,job,read,backend,numPeriods,numStates)
            ...
            obj.statehybrid(1:numPeriods,1:numStates)   = statehybrid_class;
