classdef AbstractState < SwigRef
  methods
    function delete(self)
      if self.swigInd
        CoolPropMATLAB_wrap(192, self);
        self.swigInd=uint64(0);
      end
    end
    function varargout = set_T(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(194, self, varargin{:});
    end
    ...
    function varargout = set_mole_fractions(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(199, self, varargin{:});
    end
    ...
    function varargout = update(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(206, self, varargin{:});
    end
    function varargout = update_with_guesses(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(207, self, varargin{:});
    end
    ...
    function varargout = set_binary_interaction_string(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(212, self, varargin{:});
    end
    ...
    function varargout = apply_simple_mixing_rule(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(215, self, varargin{:});
    end
    function varargout = set_fluid_parameter_double(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(216, self, varargin{:});
    end
    ...
    function varargout = specify_phase(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(225, self, varargin{:});
    end
    function varargout = unspecify_phase(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(226, self, varargin{:});
    end
    ...
    function varargout = build_spinodal(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(232, self, varargin{:});
    end
    function varargout = get_spinodal_data(self,varargin)
    ...
    function varargout = criticality_contour_values(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(234, self, varargin{:});
    end
    ...
    function varargout = hmolar_excess(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(263, self, varargin{:});
    end
    function varargout = hmass_excess(self,varargin)
    ...
    function varargout = smolar_excess(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(267, self, varargin{:});
    end
    function varargout = smass_excess(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(268, self, varargin{:});
    end
    function varargout = umolar(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(269, self, varargin{:});
    end
    function varargout = umass(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(270, self, varargin{:});
    end
    function varargout = umolar_excess(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(271, self, varargin{:});
    end
    function varargout = umass_excess(self,varargin)
    ...
    function varargout = cvmolar(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(277, self, varargin{:});
    end
    ...
    function varargout = gibbsmolar_excess(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(281, self, varargin{:});
    end
    function varargout = gibbsmass_excess(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(282, self, varargin{:});
    end
    function varargout = helmholtzmolar(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(283, self, varargin{:});
    end
    function varargout = helmholtzmass(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(284, self, varargin{:});
    end
    function varargout = helmholtzmolar_excess(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(285, self, varargin{:});
    end
    function varargout = helmholtzmass_excess(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(286, self, varargin{:});
    end
    function varargout = volumemolar_excess(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(287, self, varargin{:});
    end
    function varargout = volumemass_excess(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(288, self, varargin{:});
    end
    function varargout = speed_sound(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(289, self, varargin{:});
    end
    ...
    function varargout = fundamental_derivative_of_gas_dynamics(self,varargin)
    ...
    function varargout = true_critical_point(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(297, self, varargin{:});
    end
    function varargout = ideal_curve(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(298, self, varargin{:});
    end
    ...
    function varargout = build_phase_envelope(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(306, self, varargin{:});
    end
    ...
    function varargout = conductivity_contributions(self,varargin)
      [varargout{1:nargout}] = CoolPropMATLAB_wrap(314, self, varargin{:});
    end
    ...
    function varargout = Prandtl(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(316, self, varargin{:});
    end
    ...
    function varargout = alpha0(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(319, self, varargin{:});
    end
    function varargout = dalpha0_dDelta(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(320, self, varargin{:});
    end
    function varargout = dalpha0_dTau(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(321, self, varargin{:});
    end
    function varargout = d2alpha0_dDelta2(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(322, self, varargin{:});
    end
    function varargout = d2alpha0_dDelta_dTau(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(323, self, varargin{:});
    end
    function varargout = d2alpha0_dTau2(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(324, self, varargin{:});
    end
    function varargout = d3alpha0_dTau3(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(325, self, varargin{:});
    end
    function varargout = d3alpha0_dDelta_dTau2(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(326, self, varargin{:});
    end
    ...
    function varargout = d3alpha0_dDelta3(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(328, self, varargin{:});
    end
    function varargout = alphar(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(329, self, varargin{:});
    end
    function varargout = dalphar_dDelta(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(330, self, varargin{:});
    end
    function varargout = dalphar_dTau(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(331, self, varargin{:});
    end
    function varargout = d2alphar_dDelta2(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(332, self, varargin{:});
    end
    function varargout = d2alphar_dDelta_dTau(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(333, self, varargin{:});
    end
    function varargout = d2alphar_dTau2(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(334, self, varargin{:});
    end
    function varargout = d3alphar_dDelta3(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(335, self, varargin{:});
    end
    function varargout = d3alphar_dDelta2_dTau(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(336, self, varargin{:});
    end
    function varargout = d3alphar_dDelta_dTau2(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(337, self, varargin{:});
    end
    function varargout = d3alphar_dTau3(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(338, self, varargin{:});
    end
    function varargout = d4alphar_dDelta4(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(339, self, varargin{:});
    end
    function varargout = d4alphar_dDelta3_dTau(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(340, self, varargin{:});
    end
    function varargout = d4alphar_dDelta2_dTau2(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(341, self, varargin{:});
    end
    function varargout = d4alphar_dDelta_dTau3(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(342, self, varargin{:});
    end
    function varargout = d4alphar_dTau4(self,varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(343, self, varargin{:});
    end
  ...
  methods(Static)
    function varargout = factory(varargin)
      [varargout{1:max(1,nargout)}] = CoolPropMATLAB_wrap(193, varargin{:});
    end
  end
end
